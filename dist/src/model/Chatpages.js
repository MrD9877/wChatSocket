...
const chatsSchema = new mongoose_1.Schema({
    ...
    imagesUrl: [
        {
            imageId: { type: mongoose_1.Schema.Types.String },
            url: { type: mongoose_1.Schema.Types.String },
            dateGenerated: { type: mongoose_1.Schema.Types.Date },
        },
    ],
});
// Create and export the model
exports.ChatPage = mongoose_1.default.model("ChatPage", chatsSchema);
